  ...
  return (
    <div>
      ...
      {(() => {
        ...
        const completedCount = topicsArr.filter(t => t.pagesRead >= t.totalPages && t.totalPages > 0).length;
        let courseProgress = 0;
        if (totalTopicCount > 0) {
          const sum = topicsArr.reduce((acc, t) => {
            if (t.totalPages <= 0) return acc;
            return acc + Math.min(1, (t.pagesRead || 0) / t.totalPages);
          }, 0);
