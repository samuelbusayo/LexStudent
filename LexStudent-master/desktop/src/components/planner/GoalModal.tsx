        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full border border-outline-variant/30 rounded-lg px-3 py-2 font-body-md text-primary-container placeholder:text-on-surface-variant/50"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-outline-variant/30 rounded-lg px-3 py-2 font-body-md text-primary-container"
              />
            </div>
            <div>
              <label className="font-label-caps text-on-surface-variant block mb-1">Date</label>
              <input
                type="date"
                value={date}
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" className="flex-1 bg-primary-container text-white px-4 py-2.5 rounded-lg font-button">
              Create Goal
            </button>
          </div>
        </form>
