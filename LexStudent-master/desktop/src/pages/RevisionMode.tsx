    ...
    <main className="px-5 py-6 max-w-7xl mx-auto space-y-8">
      ...
      <section className="bg-primary-container rounded-2xl p-8 text-center space-y-4 overflow-hidden relative">
        ...
        <button
          ...
          disabled={gapCount === 0}
          className="bg-secondary text-primary font-button px-8 py-4 rounded-full relative z-10 hover:brightness-110 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
