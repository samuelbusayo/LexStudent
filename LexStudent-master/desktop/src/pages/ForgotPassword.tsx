    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-gutter">
      <div className="w-full max-w-md bg-surface-container-lowest p-stack-lg rounded-xl border border-outline-variant/30">
        <div className="text-center mb-stack-lg">
          <span className="material-symbols-outlined text-4xl text-primary mb-unit">lock_reset</span>
          <h1 className="font-h2 text-h2 text-primary mb-unit">Reset Password</h1>
        ...
        {sent ? (
          <div className="text-center space-y-stack-md">
            ...
            <p className="font-body-lg text-on-surface">Check your email for a 6-digit reset code</p>
