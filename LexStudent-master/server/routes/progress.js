...
router.get("/gaps", (req, res) => {
  ...
  const topics = db.prepare(
    `SELECT t.id, t.name, t.total_pages, t.pages_read, t.last_reviewed_at, t.review_interval_days, c.name as course_name
  ...
  for (const t of topics) {
    const mastery = t.total_pages > 0 ? t.pages_read / t.total_pages : 0;
