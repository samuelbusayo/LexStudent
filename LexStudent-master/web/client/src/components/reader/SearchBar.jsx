...
export default function SearchBar({ query, onQueryChange, currentMatch, totalMatches, onNext, onPrev, onClose }) {
    ...
    <div className="flex items-center gap-2 bg-surface-container-lowest border border-outline-variant/30 rounded-lg px-3 py-1.5 shadow-md">
      ...
      <div className="flex items-center gap-0.5">
        <button
          ...
          className="p-0.5 text-on-surface-variant hover:text-on-surface rounded transition-colors disabled:opacity-30"
